...
public abstract class Scene implements Screen, InputProcessor
{
	...
	public void render(float dt)
	{
		...
		// clear the screen
		// we set the background as gray for now
		// TODO: set the color as changeable so not all scenes have a gray background
		Gdx.gl.glClearColor(1.0f/2,1.0f/2,1.0f/2,1);
